...
impl State {
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(4, WHITE, BLACK, "Slaing by a moster, your hero's journey has come to a premature end.");
        ctx.print_color_centered(4, WHITE, BLACK, "The Amulet of Yala remains unclaimed, and your home town is not saved");
